...
import ForgetPassForm from "@/component/forgetPasswordForm/ForgetPasswordForm";
    ...
    <>
      <div className="">
        <div className="w-[445px]">
          <div className="py-5">
            <Link className="text-black flex " href={"/login"}>
          ...
          <div className="text-black font-light text-[16px] mb-5">
